...
echo "    const response = await fetch(\`\${KV_URL}/ping\`);"
echo "    console.log('✅ Connection successful:', response.status);"
echo "    "
...
echo "    "
echo "    // Set a value"
echo "    await fetch(\`\${KV_URL}/kv/\${testKey}\`, {"
echo "      method: 'PUT',"
...
echo "    "
echo "    // Get the value"
echo "    const getResponse = await fetch(\`\${KV_URL}/kv/\${testKey}\`, {"
echo "      headers: { 'Authorization': \`Bearer \${ACCESS_TOKEN}\` }"
echo "    });"
echo "    const retrievedValue = await getResponse.text();"
echo "    console.log('✅ Get operation successful:', retrievedValue);"
echo "    "
echo "    // Clean up"
echo "    await fetch(\`\${KV_URL}/kv/\${testKey}\`, {"
echo "      method: 'DELETE',"
echo "      headers: { 'Authorization': \`Bearer \${ACCESS_TOKEN}\` }"
echo "    });"
echo "    console.log('✅ Delete operation successful');"
echo "    "
...
echo "EOF"
echo ""
echo "Run test with: deno run --allow-net test_denokv.ts"
