...
echo "    console.log('✅ Set operation successful');"
echo "    "
echo "    // Get the value"
echo "    const result = await kv.get(testKey);"
echo "    console.log('✅ Get operation successful:', result.value);"
echo "    "
echo "    // Test atomic operations"
echo "    await kv.atomic()"
echo "      .set(['counter'], 1)"
echo "      .set(['last-updated'], new Date())"
echo "      .commit();"
echo "    console.log('✅ Atomic operation successful');"
echo "    "
echo "    // Test list operation"
echo "    const entries = await kv.list({ prefix: ['test'] });"
echo "    console.log('✅ List operation successful, found', entries.length, 'entries');"
echo "    "
echo "    // Clean up"
echo "    await kv.delete(testKey);"
echo "    await kv.delete(['counter']);"
echo "    await kv.delete(['last-updated']);"
echo "    console.log('✅ Cleanup successful');"
echo "    "
echo "    // Close connection"
echo "    kv.close();"
echo "    console.log('🎉 All DenoKV tests passed!');"
echo "  } catch (error) {"
