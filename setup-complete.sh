...
echo "    console.log('✅ Set operation successful - Key:', testKey, 'Value:', testValue);"
echo "    "
echo "    // Get the value"
echo "    const result = await kv.get(testKey);"
echo "    console.log('✅ Get operation successful - Retrieved:', result.value);"
echo "    "
echo "    // Clean up"
echo "    await kv.delete(testKey);"
echo "    console.log('✅ Delete operation successful - Removed key:', testKey);"
echo "    "
